...
internal sealed class AvaloniaAdapter : RAdapter
{
    ...
    static AvaloniaAdapter()
    {
        ...
        SystemFontNames = [.. FontManager.Current.SystemFonts];
    }
    ...
    protected override RBrush CreateLinearGradientBrush(RRect rect, RColor color1, RColor color2, double angle)
    {
        ...
        return new BrushAdapter(new ImmutableLinearGradientBrush(
            [
    ...
    protected override DataTransfer GetClipboardDataObjectInt(string html, string plainText)
    {
        var tran = new DataTransfer();
        tran.Add(DataTransferItem.CreateText(plainText));
        return tran;
    }
    ...
    {
        var topLevel = TryGetTopLevel(control) ?? throw new InvalidOperationException("No TopLevel available");
