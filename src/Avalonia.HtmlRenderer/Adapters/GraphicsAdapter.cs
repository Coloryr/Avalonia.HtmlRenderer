...
internal sealed class GraphicsAdapter : RGraphics
{
    ...
    private readonly Stack<DrawingContext.PushedState> _clipStackInt = new();
    ...
    public override RBrush GetTextureBrush(RImage image, RRect dstRect, RPoint translateTransformLocation)
    {
        var brush = new ImageBrush(((ImageAdapter)image).Image)
        {
            ...
            DestinationRect = new RelativeRect(Utils.Convert(dstRect).Translate(Utils.Convert(translateTransformLocation) - new Point()), RelativeUnit.Absolute),
    ...
    internal readonly struct CustomTextSource(ReadOnlyMemory<char> text, TextRunProperties defaultProperties) : ITextSource
    {
